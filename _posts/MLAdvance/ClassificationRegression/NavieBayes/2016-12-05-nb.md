---
layout: post
title: Spark-ML-0302-Naive Bayes
category: MLAdvance
catalog: yes
description: Spark机器学习算法学习——Classificition and Regression——Naive Bayes
tags:
    - Machine Learning
    -  Spark
---
...
<div  align="center"><img src="/images/spark/ml/nb/1.1.png" width = "130" height = "20" alt="1.1" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/1.2.png" width = "350" height = "50" alt="1.2" align="center" /></div>

&emsp;&emsp;实际中，我们只关心分式中的分子部分，因为分母不依赖于`C`而且特征`F_i`的值是给定的，于是分母可以认为是一个常数。这样分子就等价于联合分布模型。
重复使用链式法则，可将该式写成条件概率的形式，如下所示：

<div  align="center"><img src="/images/spark/ml/nb/1.3.png" width = "765" height = "137" alt="1.3" align="center" /></div>

&emsp;&emsp;现在“朴素”的条件独立假设开始发挥作用:假设每个特征`F_i`对于其他特征`F_j`是条件独立的。这就意味着

<div  align="center"><img src="/images/spark/ml/nb/1.4.png" width = "180" height = "21" alt="1.4" align="center" /></div>

&emsp;&emsp;所以联合分布模型可以表达为

<div  align="center"><img src="/images/spark/ml/nb/1.5.png" width = "450" height = "87" alt="1.5" align="center" /></div>

&emsp;&emsp;这意味着上述假设下，类变量`C`的条件分布可以表达为：

<div  align="center"><img src="/images/spark/ml/nb/1.6.png" width = "310" height = "48" alt="1.6" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/1.7.png" width = "500" height = "55" alt="1.7" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/1.8.png" width = "250" height = "60" alt="1.8" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/2.1.png" width = "230" height = "53" alt="2.1" align="center" /></div>

&emsp;&emsp;当用对数空间表达时，多元朴素贝叶斯分类器变成了线性分类器。

<div  align="center"><img src="/images/spark/ml/nb/2.2.png" width = "340" height = "155" alt="2.2" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/2.3.png" width = "460" height = "390" alt="2.3" align="center" /></div>
...
<div  align="center"><img src="/images/spark/ml/nb/3.1.png" width = "260" height = "55" alt="3.1" align="center" /></div>

&emsp;&emsp;其中`p_ki`表示类别`C_k`生成`term` `w_i`的概率。这个模型通常用于短文本分类。

&emsp;&emsp;根据参考文献【2】，我们以文本分类的训练和测试为例子来介绍多元朴素贝叶斯的训练和测试过程。如下图所示。

<div  align="center"><img src="/images/spark/ml/nb/3.2.png" width = "555" height = "450" alt="3.2" align="center" /></div>
