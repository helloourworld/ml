---
layout: post
title: Scala Lesson 9
description: Scala 文件 I/O
category: Language
catalog: yes
tags:
    - Scala
...
**warning**: method readLine in class DeprecatedConsole is deprecated (since 2.11.0): use the method in scala.io.StdIn

[源码](https://github.com/scala/scala/blob/v2.11.8/src/library/scala/io/StdIn.scala#L1)：
